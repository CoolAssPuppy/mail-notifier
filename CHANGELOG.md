...
## 3.7.1 (September 21, 2026)

* New compact mode. Show only accounts with new email.

Thanks Phillip for the suggestion.

## 3.7.0 (September 13, 2026)

* Accounts are reorderable
* Add custom icons to accounts

## 3.6.4 (September 12, 2026)
...
* Classic mode follows your system light or dark appearance and ignores themes
* Choose between Classic and Pretty under Menu Style in Settings
